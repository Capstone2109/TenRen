  ...
  return (
    <div className="start">
      ...
      <p>
        ...
        <li>After you finish your game the amount of money that you win will go to your trading simulator account.</li>
        <li style={{color: 'red'}}>To earn money for your trading simulator account, you are allowed to play only once.</li>
        ...
        <li>Highly recommended prior playing the game to study cryptocurrencies section of the Robin Noob (Bitcoin, Etherium, Solana..).</li>
